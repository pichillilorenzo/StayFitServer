	...
	public static void main(String[] args) {
		...
		if (args.length > 2) {
			...
			try {
				...
				System.out.print("USER_SERVICE_ENDPOINT: ");
				System.out.println(args[2]);
				
				System.out.print("USER_HISTORY_SERVICE: ");
				System.out.println(args[3]);
				
				System.out.print("USER_DIET_SERVICE: ");
				System.out.println(args[4]);
				
				System.out.print("OAUTH2_SERVICE_ENDPOINT: ");
				System.out.println(args[5]);
				
				String[] USER_SERVICE_ENDPOINT = args[2].split(":");
				...
				String[] USER_HISTORY_SERVICE_ENDPOINT = args[3].split(":");
				...
				String[] USER_DIET_SERVICE_ENDPOINT = args[4].split(":");
				...
				String[] OAUTH2_SERVICE_ENDPOINT = args[5].split(":");
