...
// available hosts
let serviceHosts = {
  "/user/services/user": [{pm2: "http://localhost:8071", java: "http://localhost:8082"}, {pm2: "http://localhost:8072", java: "http://localhost:8092"}],
  "/user_history/services/user_history": [{pm2: "http://localhost:8073", java: "http://localhost:8083"}, {pm2: "http://localhost:8074", java: "http://localhost:8093"}],
  "/user_diet/services/user_diet": [{pm2: "http://localhost:8075", java: "http://localhost:8084"}, {pm2: "http://localhost:8076", java: "http://localhost:8094"}]
}
...
function calcWeightedRes(cpu, memory, numOfRequests) {
  return (cpu * 0.40) + (memory * 0.20) + (numOfRequests * 0.40);
}
...
http.createServer(function (req, res) {
  ...
  for(let i = 0; i < resources.length; i++) {
    weighetRes.push(calcWeightedRes(resources[i].cpu, resources[i].memory, resources[i].numOfRequests));
  }
