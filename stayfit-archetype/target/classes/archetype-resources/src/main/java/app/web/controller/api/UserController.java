...
import ${package}.app.service.UserService;
...
import ${package}.userservice.User;
...
public class UserController {
	...
	public @ResponseBody ${package}.userservice.User getUserByUsername(Principal principal) throws ResourceNotFoundException {
